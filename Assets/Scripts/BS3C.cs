...
public class BS3C : MonoBehaviour
{
    #region VARIABLES
    ...
    void Update()
    {
        ...
        if (patient == 0)
        {
            ...
            if (collider.localPosition.z <= resistanceLimit && collider.localPosition.y < limYup && collider.localPosition.y > limYdown && collider.localPosition.x < limXleft && collider.localPosition.x > limXright && fuerzas.z >= forceValue)
                                                                     ...
                                                                     //angulos = hapticplugin.GimbalAngles;// si ya ha tocado algo y sobrepasa el umbral de fuerzas entonces almacena los angulos con que lo hizo
                {
                    ...
                    switch (contador)//para comprobar que bolita es necesita mirar el valor de contador
                    {
                        ...
                        case 2:
                            ...
                            d1Ref.SetActive(false);
                            d2Ref.SetActive(false);
                                                                     ...
                                                                     //angulos = hapticplugin.GimbalAngles;// si ya ha tocado algo y sobrepasa el umbral de fuerzas entonces almacena los angulos con que lo hizo
                {
                    ...
                    switch (contador)//para comprobar que bolita es necesita mirar el valor de contador
                    {
                        ...
                        case 4:
                            ...
                            d1Ref.SetActive(false);
                            d2Ref.SetActive(false);
                            d3Ref.SetActive(false);
                            d4Ref.SetActive(false);
                                                                     ...
                                                                     //angulos = hapticplugin.GimbalAngles;// si ya ha tocado algo y sobrepasa el umbral de fuerzas entonces almacena los angulos con que lo hizo
                {
                    ...
                    switch (contador)//para comprobar que bolita es necesita mirar el valor de contador
                    {
                        ...
                        case 2:
                            ...
                            d1BRef.SetActive(false);
                            d2BRef.SetActive(false);
                            ischanged = true;
                            break;
                        case 3:
                            diana4objetoB.SetActive(false);
                                                                     ...
                                                                     //angulos = hapticplugin.GimbalAngles;// si ya ha tocado algo y sobrepasa el umbral de fuerzas entonces almacena los angulos con que lo hizo
                {
                    ...
                    switch (contador)//para comprobar que bolita es necesita mirar el valor de contador
                    {
                        ...
                        case 4:
                            ...
                            d1BRef.SetActive(false);
                            d2BRef.SetActive(false);
                            d3BRef.SetActive(false);
                            d4BRef.SetActive(false);
        ...
        #endregion
        #region TargetActivationSentado
        if (collider.localPosition.z > limZ1 && patient == 0 && readyForNext == false)
        {
            d1Refmaterial.material = gristransparente;
            d2Refmaterial.material = gristransparente;
            d3Refmaterial.material = gristransparente;
            d4Refmaterial.material = gristransparente;
        ...
        #region TargetActivation Acostado
        if (collider.localPosition.z > limZ1 && patient == 1 && readyForNext == false)
        {
            switch (contador)
            {
                case 1:
        ...
        {
            if ((contador == 2 || contador == 3) && isWaiting == false)
            {
                ...
                if (num21 >= num22)
                {
                    ...
                    if (contador == 3 && collider.localPosition.z < 1.06 && (collider.localPosition.x <= -0.126 || collider.localPosition.x >= 0.093 || collider.localPosition.y >= 0.607 || collider.localPosition.y <= 0.354))
                    {
                ...
                if (num22 > num21)
                {
                    if (contador == 2 && collider.localPosition.z < 1.06 && (collider.localPosition.x <= -0.126 || collider.localPosition.x >= 0.093 || collider.localPosition.y >= 0.607 || collider.localPosition.y <= 0.354))
                    {
                        d2Refmaterial.material = rojotransaprente;
                        targetsDeleter();
                        MoveDeviation(3);
                    ...
                    if (contador == 3 && collider.localPosition.z < 0.95 && (collider.localPosition.x <= -0.126 || collider.localPosition.x >= 0.093 || collider.localPosition.y >= 1.097 || collider.localPosition.y <= 0.856))
                    {
                        d1Refmaterial.material = rojotransaprente;
                        targetsDeleter();
                        MoveDeviation(4);
            ...
            if ((contador == 4 || contador == 5) && isWaiting == false)
            {
                if (num31 >= num32)
                {
                    if (contador == 4 && collider.localPosition.z < 0.95 && (collider.localPosition.x <= -0.126 || collider.localPosition.x >= 0.093 || collider.localPosition.y >= 1.097 || collider.localPosition.y <= 0.856))
                    {
                    ...
                    if (contador == 5 && collider.localPosition.z < 1.06 && (collider.localPosition.x <= -0.126 || collider.localPosition.x >= 0.093 || collider.localPosition.y >= 0.607 || collider.localPosition.y <= 0.354))
                    {
                ...
                if (num32 > num31)
                {
                    if (contador == 4 && collider.localPosition.z < 1.06 && (collider.localPosition.x <= -0.126 || collider.localPosition.x >= 0.093 || collider.localPosition.y >= 0.607 || collider.localPosition.y <= 0.354))
                    {
                        d4Refmaterial.material = rojotransaprente;
                        targetsDeleter();
                        MoveDeviation(5);
                    ...
                    if (contador == 5 && collider.localPosition.z < 0.95 && (collider.localPosition.x <= -0.126 || collider.localPosition.x >= 0.093 || collider.localPosition.y >= 1.097 || collider.localPosition.y <= 0.856))
                    {
                        d3Refmaterial.material = rojotransaprente;
                        targetsDeleter();
                        MoveDeviation(6);
        ...
        {
            if ((contador == 2 || contador == 3) && isWaiting == false)//esto funciona para sentado ya costadoluego habr'a que ponerle otra condicion si queremos que funcione solo para sentado
            {
                Debug.Log("dentro del primer if detector");
                if (num21 >= num22)
                {
                    ...
                    if (contador == 3 && collider.localPosition.z < 1.07 && (collider.localPosition.x <= -0.66 || collider.localPosition.x >= -0.402 || collider.localPosition.y >= 0.06 || collider.localPosition.y <= -0.155))
                    {
                ...
                if (num22 > num21)
                {
                    if (contador == 2 && collider.localPosition.z < 1.07 && (collider.localPosition.x <= -0.66 || collider.localPosition.x >= -0.402 || collider.localPosition.y >= 0.06 || collider.localPosition.y <= -0.155))
                    {
                        d1BRefmaterial.material = rojotransaprente;
                        targetsDeleter();
                        MoveDeviation(3);
                    ...
                    if (contador == 3 && collider.localPosition.z < 0.962 && (collider.localPosition.x <= -0.166 || collider.localPosition.x >= 0.07 || collider.localPosition.y >= 0.06 || collider.localPosition.y <= -0.141))
                    {
                        d2BRefmaterial.material = rojotransaprente;
                        targetsDeleter();
                        MoveDeviation(4);
            ...
            if ((contador == 4 || contador == 5) && isWaiting == false)
            {
                if (num31 >= num32)
                {
                    if (contador == 4 && collider.localPosition.z < 0.962 && (collider.localPosition.x <= -0.166 || collider.localPosition.x >= 0.07 || collider.localPosition.y >= 0.06 || collider.localPosition.y <= -0.141))
                    {
                    ...
                    if (contador == 5 && collider.localPosition.z < 1.07 && (collider.localPosition.x <= -0.66 || collider.localPosition.x >= -0.402 || collider.localPosition.y >= 0.06 || collider.localPosition.y <= -0.155))
                    {
                ...
                if (num32 > num31)
                {
                    if (contador == 4 && collider.localPosition.z < 1.07 && (collider.localPosition.x <= -0.66 || collider.localPosition.x >= -0.402 || collider.localPosition.y >= 0.06 || collider.localPosition.y <= -0.155))
                    {
                        d3BRefmaterial.material = rojotransaprente;
                        targetsDeleter();
                        MoveDeviation(5);
                    ...
                    if (contador == 5 && collider.localPosition.z < 0.962 && (collider.localPosition.x <= -0.166 || collider.localPosition.x >= 0.07 || collider.localPosition.y >= 0.06 || collider.localPosition.y <= -0.141))
                    {
                        d4BRefmaterial.material = rojotransaprente;
                        targetsDeleter();
                        MoveDeviation(6);
