...
public class ControladorBisel : MonoBehaviour
{ //declaro los 18 números aleatorios que van a determinar la posición de las bolas
    ...
    public Quaternion rotationCollider;
    public int contador;
    ...
    void Start()
    {
        ...
        num11 = aleatorio.Next(0, 170); //luego para hacerlo decimal lo divido entre 100 limites del eje x
        num12 = aleatorio.Next(55, 300);//limites del eje y
        num13 = aleatorio.Next(0, 5);//cuando se vea la jaula del háptico podré determinar el número z
        Vector3 bolita1 = new Vector3((float)(num11 / 1000), (float)(num12 / 1000), (float)-0.0961);
        diana1.position = bolita1;
        /*diana1.position.x = -num11 / 100;
        diana1.position.y = num12 / 100;
        diana1.position.z = num13 / 100;*/

        num21 = aleatorio.Next(0, 170); //luego para hacerlo decimal lo divido entre 100 limites del eje x
        num22 = aleatorio.Next(55, 300);//limites del eje y
        num23 = aleatorio.Next(0, 5);//cuando se vea la jaula del háptico podré determinar el número z
        Vector3 bolita2 = new Vector3((float)(-(num21) / 1000), (float)(num22 / 1000), (float)-0.0961);
        ...
        num31 = aleatorio.Next(0, 170); //luego para hacerlo decimal lo divido entre 100 limites del eje x
        num32 = aleatorio.Next(55, 300);//limites del eje y
        num33 = aleatorio.Next(0, 5);//cuando se vea la jaula del háptico podré determinar el número z
        Vector3 bolita3 = new Vector3((float)(num31 / 1000), (float)(num32 / 1000), (float)-0.0961);
        diana3.position = bolita3;
        /*diana3.position.x = -num31 / 100;
        diana3.position.y = num32 / 100;
        diana3.position.z = num33 / 100;*/

        num41 = aleatorio.Next(0, 170); //luego para hacerlo decimal lo divido entre 100 limites del eje x
        num42 = aleatorio.Next(55, 300);//limites del eje y
        num43 = aleatorio.Next(0, 5);//cuando se vea la jaula del háptico podré determinar el número z
        Vector3 bolita4 = new Vector3((float)(-(num41) / 1000), (float)(num42 / 1000), (float)-0.0961);
        diana4.position = bolita4;
        /*diana4.position.x = num41 / 100;
        diana4.position.y = num42 / 100;
        diana4.position.z = num43 / 100;*/

        num51 = aleatorio.Next(0, 170); //luego para hacerlo decimal lo divido entre 100 limites del eje x
        num52 = aleatorio.Next(55, 300);//limites del eje y
        num53 = aleatorio.Next(0, 5);//cuando se vea la jaula del háptico podré determinar el número z
        Vector3 bolita5 = new Vector3((float)(num51 / 1000), (float)(num52 / 1000), (float)-0.0961);
        diana5.position = bolita5;
        /*diana5.position.x = -num51 / 100;
        diana5.position.y = num52 / 100;
        diana5.position.z = num53 / 100;*/

        num61 = aleatorio.Next(0, 170); //luego para hacerlo decimal lo divido entre 100 limites del eje x
        num62 = aleatorio.Next(55, 300);//limites del eje y
        num63 = aleatorio.Next(0, 5);//cuando se vea la jaula del háptico podré determinar el número z
        Vector3 bolita6 = new Vector3((float)(-(num61) / 1000), (float)(num62 / 1000), (float)-0.0961);
    ...
    void Update()
    {
        ...
        if (fuerzas != null && collider.position.z <= -0.04 && siguiente == 1){
            rotationCollider = HapticCollider.rotation;
            contadorAngulos++;
            siguiente = 0;
            switch (contadorAngulos)
            {
                case 1:
                    GAZ1 = rotationCollider.z;
                    break;
                case 2: GAZ2 = rotationCollider.z;
                    break;
                case 3: GAZ3 = rotationCollider.z;
                    break;
                case 4: GAZ4 = rotationCollider.z;
                    break;
                case 5:
                    GAZ5 = rotationCollider.z;
                    break;
                case 6:
                    GAZ6 = rotationCollider.z;
                    break;
            }

        }
        if (fuerzas.z != 0 && collider.position.z <= -0.08)
        //angulos = hapticplugin.GimbalAngles;// si ya ha tocado algo y sobrepasa el umbral de fuerzas entonces almacena los angulos con que lo hizo
        {
            ...
            switch (contador)//para comprobar que bolita es necesita mirar el valor de contador
            {
                case 0:
                    ...
                    angY1 = angulos.y;
                    angZ1 = angulos.z;
                    posX1 = referenciaTip.position.x;
                    posY1 = referenciaTip.position.y;
                    tiempobola1 = tiempo;
                    ischanged = true;
                    break;
                case 1:
                    ...
                    tiempobola2 = tiempo - tiempobola1;
                    ischanged = true;
                    break;
                case 2:
                    ...
                    tiempobola3 = tiempo - (tiempobola1 + tiempobola2);
                    ischanged = true;
                    break;
                case 3:
                    ...
                    tiempobola4 = tiempo - (tiempobola1 + tiempobola2 + tiempobola3);
                    ischanged = true;
                ...
                case 4:
                    ...
                    tiempobola5 = tiempo - (tiempobola1 + tiempobola2 + tiempobola3 + tiempobola4);
                    ischanged = true;
                ...
                case 5:
                    ...
                    tiempobola6 = tiempo - (tiempobola1 + tiempobola2 + tiempobola3 + tiempobola4 + tiempobola5);
                    ischanged = true;
